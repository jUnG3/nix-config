-- Hyprland 0.55.4 Lua configuration
...
hl.env("HYPRCURSOR_THEME", "ArcStarry")
hl.env("HYPRCURSOR_SIZE", "24")
hl.env("XCURSOR_THEME", "ArcStarry")
...
-- Original gesture remained disabled:
...
-- Switch workspaces and move windows to workspaces 1-10.
for i = 1, 10 do
    local key = i % 10
